...
export declare class ParametersJarFactory {
    ...
    protected mapParameters(operation: Operation): (import("swagger-schema-official").BodyParameter | import("swagger-schema-official").QueryParameter | (import("swagger-schema-official").HeaderParameter & {
        '$ref': string;
    }))[];
