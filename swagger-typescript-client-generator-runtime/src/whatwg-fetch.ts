...
export type WhatWgFetchFunctionType = (input: RequestInfo, init?: RequestInit) => Promise<Response>
...
): RequestFactoryType => (path, query, body, formData, headers, method, configuration: never) => {
